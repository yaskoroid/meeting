...
abstract class AbstractMapper
{
    ...
    public function resetState($object) {
        if ($this->tracked->contains($object)) {
            $this->tracked->detach($object);
        }
        if ($this->changed->contains($object)) {
            $this->changed->detach($object);
        }
        if ($this->removed->contains($object)) {
            $this->removed->detach($object);
        }
        if ($this->new->contains($object)) {
            $this->new->detach($object);
        }
    }
