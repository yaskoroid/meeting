 ...
 * @method Sql set()
 * @method Sql having()
 * @method Sql where(array $filter)
 * @method Sql between()
 * @method Sql alterTable()
 * @method Sql createTable()
 * @method Sql insertInto()
 * @method Sql values()
 * @method Sql update()
 * @method Sql asc()
 * @method Sql desc()
 * @method Sql limit($limit)
 * @method Sql offset($offset)
 * @method static Sql orderBy($field)
 */
class Sql
{
    ...
    {
        $sql = new static;
        return call_user_func_array([$sql, $operation], $parts);
    }
    ...
    protected function build($operation, $parts)
    {
        switch ($operation) { //just special cases
            ...
            case 'in':
                $parts = array_map([$this, 'buildName'], $parts);
                return $this->buildParts($parts, '(:%s) ', ', :');
            case 'createTable':
            case 'insertInto':
                $this->buildFirstPart($parts);
